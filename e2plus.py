...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 14 23:02:31 2022
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 12 11:12:50 2022
...
def kinetic_term(l1,l2,l3,n1,n2,n3,e0,e1,g):
    
    if( g >= 1.2):
     return 0.5 *(e1[l1,n1]**2 + e1[l2,n2]**2 + e0[l3,n3]**2)
    else: 
     return (e1[l1,n1] + e1[l2,n2] + e0[l3,n3])
...
def radial_terms2p(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i2_j0,vals_e1_i2_j0):
    
    val = 0.0
    if(n3 == n3p):
        
      val +=  (1.2790086e-2 ) * vals_e0_i1_j0[n1p,n1,l1]*vals_e1_i1_j0[n2p,n2,l2]
    
      val +=  (-5.5172502e-5) * (vals_e0_i2_j0[n1p,n1,l1]*vals_e1_i1_j0[n2p,n2,l2] + vals_e1_i2_j0[n2p,n2,l2]*vals_e0_i1_j0[n1p,n1,l1])
    
    return val
    
def radial_term(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e0_i1_j0,vals_e1_i1_j0):
    
    if(n3 == n3p):
        
      return vals_e0_i1_j0[n1p,n1,l1]*vals_e1_i1_j0[n2p,n2,l2]
...
def angular_term_zsq(l1,n1,l2,n2,l3,n3,l1p,n1p,l2p,n2p,l3p,n3p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i0_j1,vals_e1_i0_j1,vals_zsq):
    ...
    #z^2 term
      ...
      if((l3p == l3) and (n3p == n3)): #sanity check
       ...
       if((abs(l1p-l1) == 2 or l1p == l1) and (abs(l2p-l2) == 2 or l2p == l2)):
           ...
           if( l1p == l1):
               val *= vals_e0_i1_j0[(n1p,n1,l1)]
           elif(l1p - l1 == 2):
               val *= vals_e0_i0_j1[(n1,n1p,l1)]
           elif(l1p -l1 == -2):  
               val *= vals_e0_i0_j1[(n1p,n1,l1p)]
                   
               
               
               
           if( l2p == l2):
               val *= vals_e1_i1_j0[(n2p,n2,l2)]
           elif(l2p - l2 == 2):
               val *= vals_e1_i0_j1[(n2,n2p,l2)]   
           elif(l2p -l2 == -2):  
               val *= vals_e1_i0_j1[(n2p,n2,l2p)]
...
def angular_term_xysq(l1,n1,l2,n2,l3,n3,l1p,n1p,l2p,n2p,l3p,n3p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i0_j1,vals_e1_i0_j1,vals_xysq):
...
def get_gauge_invariant_ham(H,M,g,indices,e0,e1,vals_e0_i1_j0,vals_e0_i0_j1,vals_e0_i2_j0,vals_e0_i3_j0,vals_e1_i1_j0,vals_e1_i0_j1,vals_e1_i2_j0,vals_e1_i3_j0,vals_zsq,vals_xysq):
   ...
   for i in range(0,M):
       ...
       elif((tuple([l1p,n1p]) == tuple([l2p,n2p]) )):
           
         norm_i = 1./2.
       
       elif((tuple([l1p,n1p]) == tuple([l3p,n3p])) or (tuple([l2p,n2p]) == tuple([l3p,n3p]))):  
         norm_i = 1./(np.sqrt(2.))
       ...
       for j in range(0,M):
          ...
          elif((tuple([l1,n1]) == tuple([l2,n2]) )):
          
              norm_j = 1./2.
          
          elif ((tuple([l1,n1]) == tuple([l3,n3])) or (tuple([l2,n2]) == tuple([l3,n3]))):  
              norm_j = 1./(np.sqrt(2.))
          ...
          for [a,b] in list(permutations([0,1])):
                  ...
                  for [k,l] in list(permutations([0,1])):
                     ...
                     if( (tuple([l1,n1]) == tuple([l1p,n1p])) and (tuple([l2,n2]) == tuple([l2p,n2p])) and (tuple([l3,n3]) == tuple([l3p,n3p]))):
                       val +=   (1./(1./(g**2) + alpha_1)) * kinetic_term(l1,l2,l3,n1,n2,n3,e0,e1,g)
                   
                 
                     if((l1 == l1p) and (l2 == l2p) and (l3 ==l3p)):  
                         
                       val += 0.5 * ((1./(g**2)) + alpha_2) * radial_term(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e1_i1_j0,vals_e1_i1_j0)
                   
                       val += 0.5 * ((1./(g**2)) + alpha_2) * radial_term(l1,l3,l2,n1,n3,n2,n1p,n3p,n2p,vals_e1_i1_j0,vals_e0_i1_j0)
                       val += 0.5 * ((1./(g**2)) + alpha_2) * radial_term(l2,l3,l1,n2,n3,n1,n2p,n3p,n1p,vals_e1_i1_j0,vals_e0_i1_j0)
                       
                       # two particle terms
                       val += radial_terms2p(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e1_i1_j0,vals_e1_i1_j0,vals_e1_i2_j0,vals_e1_i2_j0)
                       val += radial_terms2p(l1,l3,l2,n1,n3,n2,n1p,n3p,n2p,vals_e1_i1_j0,vals_e0_i1_j0,vals_e1_i2_j0,vals_e0_i2_j0)
                       val += radial_terms2p(l2,l3,l1,n2,n3,n1,n2p,n3p,n1p,vals_e1_i1_j0,vals_e0_i1_j0,vals_e1_i2_j0,vals_e0_i2_j0)
                       
                       
                      
                       # single particle terms
                       val += radial_terms1p(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e1_i1_j0,vals_e1_i2_j0,vals_e1_i3_j0,g)
                       val += radial_terms1p(l2,l1,l3,n2,n1,n3,n2p,n1p,n3p,vals_e1_i1_j0,vals_e1_i2_j0,vals_e1_i3_j0,g)
                       val += radial_terms1p(l3,l1,l2,n3,n1,n2,n3p,n1p,n2p,vals_e0_i1_j0,vals_e0_i2_j0,vals_e0_i3_j0,g)
                       
                       
                       val += (-1.2423581e-3 ) * vals_e1_i1_j0[n1p,n1,l1]*vals_e1_i1_j0[n2p,n2,l2]*vals_e0_i1_j0[n3p,n3,l3]
                       

                 
                     if((l3 == l3p) and (n3p == n3)):
                       val -= 0.5 * (1./(g**2) + alpha_2) * 3.*angular_term_zsq(l1,n1,l2,n2,l3,n3,l1p,n1p,l2p,n2p,l3p,n3p,vals_e1_i1_j0,vals_e1_i1_j0,vals_e1_i0_j1,vals_e1_i0_j1,vals_zsq)  
                       val -= 0.5 * (1./(g**2) + alpha_2) * 6.*angular_term_xysq(l1,n1,l2,n2,l3,n3,l1p,n1p,l2p,n2p,l3p,n3p,vals_e1_i1_j0,vals_e1_i1_j0,vals_e1_i0_j1,vals_e1_i0_j1,vals_xysq)
         
                     if((l2 == l2p) and (n2p == n2)):
                       val -= 0.5 * (1./(g**2) + alpha_2) * 3.*angular_term_zsq(l1,n1,l3,n3,l2,n2,l1p,n1p,l3p,n3p,l2p,n2p,vals_e1_i1_j0,vals_e0_i1_j0,vals_e1_i0_j1,vals_e0_i0_j1,vals_zsq)  
                       val -= 0.5 * (1./(g**2) + alpha_2) * 6.*angular_term_xysq(l1,n1,l3,n3,l2,n2,l1p,n1p,l3p,n3p,l2p,n2p,vals_e1_i1_j0,vals_e0_i1_j0,vals_e1_i0_j1,vals_e0_i0_j1,vals_xysq)
        
                     if((l1 == l1p) and (n1p == n1)):
                       val -= 0.5 * (1./(g**2) + alpha_2) * 3.*angular_term_zsq(l2,n2,l3,n3,l1,n1,l2p,n2p,l3p,n3p,l1p,n1p,vals_e1_i1_j0,vals_e0_i1_j0,vals_e1_i0_j1,vals_e0_i0_j1,vals_zsq)  
                       val -= 0.5 * (1./(g**2) + alpha_2) * 6.*angular_term_xysq(l2,n2,l3,n3,l1,n1,l2p,n2p,l3p,n3p,l1p,n1p,vals_e1_i1_j0,vals_e0_i1_j0,vals_e1_i0_j1,vals_e0_i0_j1,vals_xysq)
...
def e1p_indices(lmax,nmax):
    ...
    for ls in Ls:
     ...
     for ns in Ns:
         ...
         for [a,b] in list(permutations([0,1])):
            ...
            perm_index = [ls[a],ls[b],ls[2],ns[a],ns[b],ns[2]]
    ...
    time1 = time.time()
    print("Time for computing unpermuted e1+ indices ",time1-time0)
    return indices_list
...
def energies(indices_list,e0, e1,g):
    energies =list()
    ...
    for i in range(0,len(indices_list)):
        ...
        if( g < 1.2):
         E_i = (e1[l1,n1] + e1[l2,n2] + e0[l3,n3])
        else: 
         E_i = 0.5 * (e1[l1,n1]**2 + e1[l2,n2]**2 + e0[l3,n3]**2)
...
def get_eigenvalues(g,M,lmax,nmax):
    #indices=e1p_indices(lmax, nmax)
    
    
   
    with open('e1+_indices', 'rb') as fp:
    ...
    if ( g >= 1.2):
     ...
     with open('epsilon_e1','rb') as fp:
      e1 = pickle.load(fp) 
   
    else:
     with open('epsilon_e0_typeB', 'rb') as fp:
         
         e0  = pickle.load(fp).reshape(21,10)
         
         
     e1  = np.loadtxt("epsilon_typeB_e_1_omega_1.5.csv", delimiter=',').reshape((21,10))
    
    
    Es = energies(indices, e0, e1,g)
    ...
    print("------------------------------------")
    #Ls=remove_perms(indices_sorted)
    
    #print(Ls)
   
    
   
    # loading 1-particle radial integrals
    if( g >= 1.2):
     with open('F_i1_j0_e0', 'rb') as fp:
        vals_e0_i1_j0 = pickle.load(fp)
     with open('F_i0_j1_e0', 'rb') as fp:
        vals_e0_i0_j1 = pickle.load(fp)
     with open('F_i2_j0_e0', 'rb') as fp:
        vals_e0_i2_j0 = pickle.load(fp)    
     with open('F_i3_j0_e0', 'rb') as fp:
        vals_e0_i3_j0 = pickle.load(fp)        
   
     with open('F_i1_j0_e1', 'rb') as fp:
        vals_e1_i1_j0 = pickle.load(fp)
     with open('F_i0_j1_e1', 'rb') as fp:
        vals_e1_i0_j1 = pickle.load(fp)
     with open('F_i2_j0_e1', 'rb') as fp:
        vals_e1_i2_j0 = pickle.load(fp)    
     with open('F_i3_j0_e1', 'rb') as fp:
        vals_e1_i3_j0 = pickle.load(fp)
      ...
      vals_e0_i3_j0  = np.loadtxt("flatFi3j0List.csv", delimiter=',').reshape((10, 10, 21))
    
    
      vals_e1_i0_j1  = np.loadtxt("flat_F_i0_j1_e1_typeB_omega1.5.csv", delimiter=',').reshape((10, 10, 19))
      vals_e1_i1_j0  = np.loadtxt("flat_F_i1_j0_e1_typeB_omega1.5.csv", delimiter=',').reshape((10, 10, 21))
      vals_e1_i2_j0  = np.loadtxt("flat_F_i2_j0_e1_typeB_omega1.5.csv", delimiter=',').reshape((10, 10, 21))
      vals_e1_i3_j0  = np.loadtxt("flat_F_i3_j0_e1_typeB_omega1.5.csv", delimiter=',').reshape((10, 10, 21))
    ...
    H = get_gauge_invariant_ham(H,M,g,indices_sorted,e0,e1,vals_e0_i1_j0,vals_e0_i0_j1,vals_e0_i2_j0,vals_e0_i3_j0,vals_e1_i1_j0,vals_e1_i0_j1,vals_e1_i2_j0,vals_e1_i3_j0,vals_zsq,vals_xysq)
...
#print(H.shape)
#print("# of non-zero elements: ",np.count_nonzero(H))
#print("Ground state energy :",evals[0])
#print("1st excited state energy :",evals[1])
