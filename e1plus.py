...
def kinetic_term(l1,l2,l3,n1,n2,n3,e0,e1,g):
    ...
    if(g >= 1.2):
     return 0.5 *(e0[l1,n1]**2 + e0[l2,n2]**2 + e1[l3,n3]**2)
    else:  
     return (e0[l1,n1] + e0[l2,n2] + e1[l3,n3])
          ...
          for [a,b] in list(permutations([0,1])):
                  ...
                  for [k,l] in list(permutations([0,1])):
                     ...
                     if((l1 == l1p) and (l2 == l2p) and (l3 == l3p)):  
                       ...
                       val += 0.5 * ((1./(g**2)) + alpha_2) * radial_term(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e0_i1_j0,vals_e0_i1_j0)
                   
                       val += 0.5 * ((1./(g**2)) + alpha_2) * radial_term(l1,l3,l2,n1,n3,n2,n1p,n3p,n2p,vals_e0_i1_j0,vals_e1_i1_j0)
                       val += 0.5 * ((1./(g**2)) + alpha_2) * radial_term(l2,l3,l1,n2,n3,n1,n2p,n3p,n1p,vals_e0_i1_j0,vals_e1_i1_j0)
                       
                       # two particle terms
                       val += radial_terms2p(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e0_i1_j0,vals_e0_i1_j0,vals_e0_i2_j0,vals_e0_i2_j0)
                       val += radial_terms2p(l1,l3,l2,n1,n3,n2,n1p,n3p,n2p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i2_j0,vals_e1_i2_j0)
                       val += radial_terms2p(l2,l3,l1,n2,n3,n1,n2p,n3p,n1p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i2_j0,vals_e1_i2_j0)
                       
                       
                      
                       # single particle terms
                       val += radial_terms1p(l1,l2,l3,n1,n2,n3,n1p,n2p,n3p,vals_e0_i1_j0,vals_e0_i2_j0,vals_e0_i3_j0,g)
                       val += radial_terms1p(l2,l1,l3,n2,n1,n3,n2p,n1p,n3p,vals_e0_i1_j0,vals_e0_i2_j0,vals_e0_i3_j0,g)
                       val += radial_terms1p(l3,l1,l2,n3,n1,n2,n3p,n1p,n2p,vals_e1_i1_j0,vals_e1_i2_j0,vals_e1_i3_j0,g)
                       
                       
                       val += (-1.2423581e-3 ) * vals_e0_i1_j0[n1p,n1,l1]*vals_e0_i1_j0[n2p,n2,l2]*vals_e1_i1_j0[n3p,n3,l3]
                     ...
                     if((l3 == l3p) and (n3p == n3)):
                       ...
                       val -= 0.5 * (1./(g**2) + alpha_2) * 3.*angular_term_zsq(l1,n1,l2,n2,l3,n3,l1p,n1p,l2p,n2p,l3p,n3p,vals_e0_i1_j0,vals_e0_i1_j0,vals_e0_i0_j1,vals_e0_i0_j1,vals_zsq)  
                       val -= 0.5 * (1./(g**2) + alpha_2) * 6.*angular_term_xysq(l1,n1,l2,n2,l3,n3,l1p,n1p,l2p,n2p,l3p,n3p,vals_e0_i1_j0,vals_e0_i1_j0,vals_e0_i0_j1,vals_e0_i0_j1,vals_xysq)
         
                     if((l2 == l2p) and (n2p == n2)):
                       val -= 0.5 * (1./(g**2) + alpha_2) * 3.*angular_term_zsq(l1,n1,l3,n3,l2,n2,l1p,n1p,l3p,n3p,l2p,n2p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i0_j1,vals_e1_i0_j1,vals_zsq)  
                       val -= 0.5 * (1./(g**2) + alpha_2) * 6.*angular_term_xysq(l1,n1,l3,n3,l2,n2,l1p,n1p,l3p,n3p,l2p,n2p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i0_j1,vals_e1_i0_j1,vals_xysq)
        
                     if((l1 == l1p) and (n1p == n1)):
                       val -= 0.5 * (1./(g**2) + alpha_2) * 3.*angular_term_zsq(l2,n2,l3,n3,l1,n1,l2p,n2p,l3p,n3p,l1p,n1p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i0_j1,vals_e1_i0_j1,vals_zsq)  
                       val -= 0.5 * (1./(g**2) + alpha_2) * 6.*angular_term_xysq(l2,n2,l3,n3,l1,n1,l2p,n2p,l3p,n3p,l1p,n1p,vals_e0_i1_j0,vals_e1_i1_j0,vals_e0_i0_j1,vals_e1_i0_j1,vals_xysq)
...
def energies(indices_list,e0, e1,g):
    ...
    for i in range(0,len(indices_list)):
        ...
        if( g < 1.2):
         E_i = (e0[l1,n1] + e0[l2,n2] + e1[l3,n3]) 
        else:
         E_i = 0.5 * (e0[l1,n1]**2 + e0[l2,n2]**2 + e1[l3,n3]**2)
...
def get_eigenvalues(g,M,lmax,nmax):
    ...
    #H = simplify(H,M) # perturbation theory simplification
